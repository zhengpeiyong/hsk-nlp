...
public class Word2VEC {
    ...
    public static void main(String[] args) throws IOException {
        ...
        vec.loadJavaModel("C:\\Users\\heave\\Desktop\\训练模型.txt");
        
        System.out.println("结核性淋巴管炎--" + "\t" +Arrays.toString(vec.getWordVector("结核性淋巴管炎")));
    ...
    public void loadJavaModel(String path) {
        try {
            ...
            words = dis.readInt();
            size = dis.readInt();
            System.out.println("wordsSize = "+words);
