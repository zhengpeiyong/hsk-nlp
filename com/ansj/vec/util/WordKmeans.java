...
public class WordKmeans {
    ...
    public static void main(String[] args) {
        ...
        vec.loadJavaModel("C:\\Users\\heave\\Desktop\\model.txt");
		//System.out.println("中国" + "\t" +Arrays.toString(vec.getWordVector("中国")));
		//System.out.println("赵云" + "\t" +Arrays.toString(vec.getWordVector("赵云")));
		//System.out.println("赵四" + "\t" + Arrays.toString(vec.getWordVector("赵四")));
    ...
    public Classes[] explain() {
        ...
        System.out.println("wordMapLength:"+wordMap.size());
        System.out.println("cArrayLength:"+cArray.length);
